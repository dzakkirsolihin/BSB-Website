<x-app-layout>
    ...
    <section class="py-5">
        <div class="container text-center">
          <h2 class="display-5 fw-bold text-success mb-4">Alamat TK/KOBER</h2>
          <div class="d-flex align-items-start justify-content-center">
            <i class="bi bi-geo-alt-fill text-success fs-3 me-3"></i>
            <div>
              <p class="mb-1">Jl. T. Ismail XVII No.10, Sekeloa, Kecamatan Coblong, Kota Bandung, Jawa Barat 40134</p>
              <a href="https://maps.app.goo.gl/PBh8HzK695E8zKVq9" target="_blank" rel="noopener noreferrer" class="btn btn-success btn-sm">
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                @foreach(['Ruang Kelas', 'Ruang Perpustakaan', 'Ruang Aula', 'Tempat Bermain Anak', 'Mushola', 'Ruang Tidur Anak', 'Televisi Pembelajaran'] as $facility)
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                @foreach(['Cooking Class', 'Outing Class', 'Posyandu', 'Family Gathering', 'Entrepreneurship', 'Murojaah Hafalan', 'Panggung Cerita', 'Pemeriksaan Kesehatan', 'Parenting Class'] as $activity)
                <div class="col" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 100 }}">
                    <div class="card h-100 border-0 shadow-sm text-center hover-card">
                        <div class="card-body">
