<x-app-layout>
    ...
    <section class="py-5">
        <div class="container text-center">
          <h2 class="display-5 fw-bold text-success mb-4">Alamat Daycare</h2>
          <div class="d-flex align-items-start justify-content-center">
            <i class="bi bi-geo-alt-fill text-success fs-3 me-3"></i>
            <div>
              <p class="mb-1">Jl. Kanayakan Bawah No.6, Dago, Kecamatan Coblong, Kota Bandung, Jawa Barat 40135</p>
              <a href="https://maps.app.goo.gl/LQ5VxmEWCnr5mYk49" target="_blank" rel="noopener noreferrer" class="btn btn-success btn-sm">
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                @foreach(['Berbaris', 'Membaca Doa Belajar', 'Membaca Asmaul Husna', 'Doa-doa Harian', 'Murojaah Surat Pendek', 'Kegiatan Inti', 'Makan Siang', 'Tidur Siang'] as $activity)
                <div class="col" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 100 }}">
                    <div class="card h-100 border-0 shadow-sm text-center hover-card">
                        <div class="card-body">
