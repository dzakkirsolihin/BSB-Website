...
<x-app-layout>
    <!--hero start-->
    <section class="hero" id="home" style="min-height: 100vh; display: flex; align-items: center; position: relative; background-image: url('{{ asset('Assets/img/hero.JPG') }}'); background-repeat: no-repeat; background-size: cover; background-position: center;">
        <main class="content" data-aos="fade-right">
            <h3>Halo, Selamat Datang</h3>
            <h2 class="fw-bold" style="color: #ccff33; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8); -webkit-text-stroke: 0.8px black; paint-order: stroke;">YAYASAN BAITUSH SHOLIHIN</h2>
            <p>
        ...
        <div class="program-list">
            <div class="program-item" data-aos="fade-right">
                ...
                <div class="program-content">
                    ...
                    <a href="page/daycare/daycare.html"><button class="btn btn-dark">Selengkapnya</button></a>
                </div>
            </div>
            ...
            <div class="program-item" data-aos="fade-left">
                ...
                <div class="program-content">
                    ...
                    <a href="page/tk/tk.html"><button class="btn btn-dark">Selengkapnya</button></a>
                </div>
            </div>
        </div>
    </section>
