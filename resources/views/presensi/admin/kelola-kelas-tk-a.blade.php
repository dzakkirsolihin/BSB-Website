            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="deleteAllMuridForm" method="POST" action="{{ route('murid.destroyAll', ['kelas_id' => 2]) }}">
                            @csrf
                            @method('DELETE')
                            <input type="hidden" name="kelas_id" id="kelas_id" value="2">
                            <div class="mb-3">
                                <label for="admin_password" class="form-label">Password Admin</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteAllButton.addEventListener('click', function() {
                const kelas_id = 2; // ID kelas TK A
