    ...
    <div class="container">
        ...
        <div class="table-responsive">
            ...
            <table class="table custom-table">
                ...
                <tbody>
                    @foreach ($dataMuridBestari as $murid)
                        <tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="deleteAllMuridForm" method="POST" action="{{ route('murid.destroyAll', ['kelas_id' => 4]) }}">
                            @csrf
                            @method('DELETE')
                            <input type="hidden" name="kelas_id" id="kelas_id" value="4">
                            <div class="mb-3">
                                <label for="admin_password" class="form-label">Password Admin</label>
                                <input type="password" class="form-control" id="admin_password" name="admin_password" placeholder="Silahkan masukkan password admin" required>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteAllButton.addEventListener('click', function() {
                const kelas_id = 4; // ID kelas Bestari
